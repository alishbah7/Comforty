...
const Footer: React.FC = () => {
    ...
    return (  
        <div>
            ...
            <div className='container mx-auto flex flex-col gap-[20px] lg:gap-[0] lg:flex-row justify-between items-start lg:items-center px-[10px] xl:px-[80px]'>  
                ...
                <div className='flex flex-col sm:flex-row gp-[20px] sm:gap-[60px] xl:gap-[100px]'>
                    <div className='flex flex-col lg:mt-[-20px]' data-aos='zoom-in'>
                        ...
                        <ul className='text-black text-[12px]'>  
                ...
                <div className='flex'>  
                    ...
                    className='border border-gray-300 p-2 rounded-md focus:outline-none w-[160px] sm:w-[180px] xl:w-[240px] mt-[10px] h-[35px] sm:h-[40px]'  
                    />  
                    <button className='bg-[#029FAE] text-white text-[13px] sm:text-[16px] w-[65px] sm:w-[100px] h-[35px] sm:h-[40px] p-1 ml-[8px] sm:ml-[10px] mt-[10px] rounded-md'>  
                    Subscribe  
                    </button>  
                </div>  
