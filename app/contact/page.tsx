    ...
    <div>
      <div className='max-w-4xl mx-auto p-5'>
        ...
        <p className='text-center mb-6 text-gray-400' data-aos='fade-right'>
          ...
          An Email. Our Staff Always There To Help You Out. Do Not Hesitate!</p>
      ...
      {showPopup && (
        <div className='fixed inset-0 flex justify-center items-center bg-black bg-opacity-50 px-[20px]'>
          <div className='bg-white p-5 rounded-lg shadow-lg text-center'>
            ...
            <button className='mt-3 bg-[#007580] text-white px-4 py-2 rounded' onClick={() => setShowPopup(false)}>OK</button>
          </div>
        </div>
      )}
